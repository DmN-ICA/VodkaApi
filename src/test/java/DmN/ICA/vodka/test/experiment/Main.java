...
public class Main {
    public static void main(String[] args) {
        ...
        VodkaModImpl mod0 = new VodkaModImpl();
        mod0.id = "mod0";
        loader.mods.add(mod0);

        VodkaModImpl mod1 = new VodkaModImpl();
        mod1.id = "mod1";
        mod1.loadPrev.add("mod0");
        loader.mods.add(mod1);

        VodkaModImpl mod2 = new VodkaModImpl();
        mod2.id = "mod2";
        mod2.loadPost.add("mod0");
        loader.mods.add(mod2);

        VodkaModImpl mod3 = new VodkaModImpl();
        mod3.id = "mod3";
        mod3.loadPrev.add("mod2");
        mod3.loadPost.add("mod1");
        loader.mods.add(mod3);

        VodkaModImpl mod4 = new VodkaModImpl();
        mod4.id = "mod4";
